...
# 3. Crea e addestra il modello MLP
...
# Addestra il modello
mlp_model.fit(X_train_scaled, y_train_numeric)
...
joblib.dump(mlp_model, 'sentiment_model_mlp.joblib')
...
def predict_sentiment(tweet):
    ...
    # Predict
    prediction_numeric = mlp_model.predict(tweet_vector_scaled)
