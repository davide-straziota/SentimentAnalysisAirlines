...
# 3. Crea e addestra il modello XGBoost
...
joblib.dump(xgb_model, 'sentiment_model_xgb.joblib')
joblib.dump(scaler, 'scaler_xgb.joblib')
joblib.dump(label_encoder, 'label_encoder_xgb.joblib')
...
def predict_sentiment(tweet):
    ...
    # Predict
    prediction_numeric = xgb_model.predict(tweet_vector_scaled)
