...
final_model = LinearSVC(**grid_search.best_params_, random_state=42)
final_model.fit(X_train_scaled, y_train)

# 9. Save the model and scaler for later use
joblib.dump(final_model, 'sentiment_model_svm.joblib')
joblib.dump(scaler, 'scaler.joblib')
print("\nModel and scaler saved as 'sentiment_model_svm.joblib' and 'scaler.joblib'")
